...
<template>
  ...
  <div class="view-container">
    <p>
      ...
      Au cours de ma formation j'ai eu l'occasion de voir des framework tel que : Laravel, VueJs, React, NestJs. Mais j'ai aussis découvert les bases de données  tel que mysql ou mongodb.
