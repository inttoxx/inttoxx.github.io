        ...
        <div class="content w-100">
            <div class="project-description">
                <div class="project-title">
                    ...
                    <p>Projet scolaire (2 semaines)</p>
                </div>
                <p>
                    Objectif : <br>
                    développer un site de partage d'activités sur starsbourg
                </p>
                <p class="description-text">
                    ...
                    était de rédiger une documentation compléte. Vous trouverez donc sur git hub toute la documentation que j'ai rédigé.
                </p>
                <div>
